...
const LogOutModal = ({ user, open }) => {
    ...
    return (
        <>
            {open &&
                <Collapse in={open}>
                    <div className='bg-[#242627] w-[350px] h-[330px] absolute right-5 top-20 rounded-xl px-5 py-7'>
                        <div className='p-5 bg-[#252728] shadow-2xl rounded-xl'>
                            <div className='flex items-center mb-3 py-3 px-2 hover:bg-white/10 rounded-xl'>
                                ...
                                />
                                <h2 className='text-gray-200 text-lg font-bold'>{user.name}</h2>
                            </div>
                            <Divider className="bg-gray-400" />
                            <button
                                className='w-full bg-[#4F5151] mt-5 text-white font-bold text-sm'
                            >
                                See All Profiles
                            </button>
                        </div>
                        ...
                        >
                            ...
                            <h3 className='text-gray-200 text-base font-bold'>Log Out</h3>
                        </div>
                    </div>
                </Collapse>
            }
